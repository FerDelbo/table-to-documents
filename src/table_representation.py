...
class TableRepresentation:
    ...
    def to_linearized_column_wise(self) -> str:
        """
        Representar uma estrutura bidimensional em uma sequência linear de tokens.
        Para cada coluna, lista os valores correspondentes, seguindo a formatação "coluna: linha".
        A tabela deve ter linhas para usar essa representação.
    ...
    def to_linearized_row_wise(self) -> str:
        """
        Representar uma estrutura bidimensional em uma sequência linear de tokens.
        Leitura horinzontal da tabela.
        Cada linha é representada como um conjunto de pares chave-valor.
        Para usar essa representação a tabela deve ter linhas.
    ...
    def to_template_based(self) -> str:
        """
        Transformar a tabela em uma sequência em linguagem natural.
        Transforma uma linha da tabela em uma frase ou sentença gramaticalmente estruturada.
    ...
    def to_serialized_flat(self) -> str:
        ...
        separando colunas e linhas com tokens.
